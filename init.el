...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '((elixir-format :location (recipe :fetcher github
                                                                       :repo "anildigital/mix-format.el")))
